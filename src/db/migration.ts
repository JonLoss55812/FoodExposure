/**
 * The full schema migration, as a single SQL script.
 *
 * Extracted from `DatabaseProvider` so it is reachable from a test: the whole
 * data layer used to live inside a template literal inside a React component,
 * which is why v0.5.170 shipped a stray backtick that terminated the literal
